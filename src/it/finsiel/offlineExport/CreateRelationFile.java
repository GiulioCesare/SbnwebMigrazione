...
//	String inputFile, outputFile;
	...
	// 02/10/2020	
	final static int RELAZIONE_LUOGO_LUOGO_INDICE = 34;
	final static int RELAZIONE_LUOGO_LUOGO_INV_INDICE = 35;
...
else if (relazione == RELAZIONE_LUOGO_LUOGO_INDICE || relazione == RELAZIONE_LUOGO_LUOGO_INV_INDICE)
{
...
void 	creaRelazioneLuoLuoIndice(String ar[])
{
	if (relazione == RELAZIONE_LUOGO_LUOGO_INDICE )
	{
		sourceId = ar[0];
		targetId = ar[1];
	}
...
//  ------    
    ...
    else if (args[0].indexOf("tr_luo_luo.out.inv") != -1)
    {
    	if (createRelationFile.db == createRelationFile.DB_INDICE)
    		createRelationFile.relazione = RELAZIONE_LUOGO_LUOGO_INV_INDICE;
    	else
    		createRelationFile.relazione = RELAZIONE_LUOGO_LUOGO_INV;
    }
    else if (args[0].indexOf("tr_luo_luo.out") != -1)
    {
    	if (createRelationFile.db == createRelationFile.DB_INDICE)
    		createRelationFile.relazione = RELAZIONE_LUOGO_LUOGO_INDICE;
    	else
